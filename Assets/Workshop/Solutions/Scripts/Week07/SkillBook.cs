...
using UnityEngine;
    ...
    public class SkillBook : MonoBehaviour
    {
        ...
        Skill thunderbolt;
        Skill thunderboltbolt;
        Skill thunderboltboltbolt;
        Skill lightningThunder;
        ...
        thunderbolt = new Skill("Thunderbolt");
        thunderboltbolt = new Skill("Thunderboltbolt");
        thunderboltboltbolt = new Skill("Thunderboltboltbolt");
        lightningThunder = new Skill("LightningThunder");
        // build skill tree
        // └── Attack
        //     └── FireStorm
        //         ├── FireBlast
        ...
        attack.nextSkills.Add(thunderbolt);
        thunderbolt.nextSkills.Add(thunderboltbolt);
        thunderboltbolt.nextSkills.Add(thunderboltboltbolt);
        thunderboltboltbolt.nextSkills.Add(lightningThunder);
